    ...
    with st.spinner(
        ...
        def get_job_count_df():
            return _job_count_calculation.make_job_count_df(
                params_df=params_df, run_results=results_all_runs
            )
        ...
        with tab1:
            ...
            historic_rota_df, historic_callsign_df, historic_servicing_df = (
                get_historic_params()
            )
            ...
            def get_historic_utilisation_dfs(
                ...
                historical_monthly_resource_utilisation_df = pd.read_csv(
                    historical_monthly_resource_utilisation_path
                )
            ...
            with t1_col1:
                ...
                ) = _vehicle_calculation.get_perc_unattended_string_normalised(
                    results_all_runs
                )
                ...
                with iconMetricContainer(
                    ...
                    missed_calls_hist_string = (
                        _job_count_calculation.plot_historical_missed_jobs_data(
                            format="string"
                        )
                    )
            ...
            with col_ec_cc_sim:
                ...
                sim_missed_all_reg = get_missed_jobs_fig(
                    "REG", missed_jobs_care_cat_summary
                ) + get_missed_jobs_fig(
                    "REG - Helicopter Benefit", missed_jobs_care_cat_summary
                )
                sim_missed_reg_heli_benefit = get_missed_jobs_fig(
                    "REG - Helicopter Benefit", missed_jobs_care_cat_summary
                )
        ...
        with tab2:
            ...
            with tab_2_1:
                ...
                def missed_jobs():
                    ...
                    st.plotly_chart(
                        _job_count_calculation.plot_missed_jobs(
